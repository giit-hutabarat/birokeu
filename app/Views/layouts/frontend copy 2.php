...
<head>
    ...
    <!-- PENTING: Gunakan Vue dan Vuetify CDN -->
    ...
    <style>
        .bg-sidebar {
            background-color: #37474F !important; /* Blue Grey Darken 3 */
        }
    </style>
    ...
    <div id="preloader">
        ...
        <v-app>
            ...
            <v-app-bar app elevate-on-scroll color="white" height="64">
                ...
                <!-- 🔑 MENU USER MINIMALIS DI FRONTEND (Jika Login) -->
                <?php if ($isLoggedIn) : ?>
                <v-menu offset-y left>
                    <template v-slot:activator="{ on, attrs }">
                        <!-- Activator: Hanya Ikon Avatar -->
                    ...
                    <v-card class="rounded-lg elevation-4" min-width="250">
                        ...
                        <!-- Aksi Utama: Dashboard & Logout SAJA -->
                        <v-list dense>
                            <!-- Link ke Dashboard -->
                            <v-list-item link href="<?= base_url('dashboard'); ?>">
                                <v-list-item-icon><v-icon color="indigo">mdi-view-dashboard</v-icon></v-list-item-icon>
                                <v-list-item-content><v-list-item-title>Dashboard Admin</v-list-item-title></v-list-item-content>
                            </v-list-item>
            ...
            <!-- ... (v-dialog, snackbar, dan footer lainnya tetap sama) ... -->
